...
class TestConfCli(unittest.TestCase):
    ...
    def test_conf_cli_kv_delim_set(self):
        """Test by setting a value into given key position with mentioned kv_delim."""
    ...
    def test_conf_cli_wrong_kv_delim(self):
        """Test by trying to set a value into given key position with wrong kv_delim mentioned."""
        set_cmd = "conf json:///tmp/file1.json set -d : cluster>id=093d"
        set_cmd_proc = SimpleProcess(set_cmd)
    ...
    def test_conf_cli_invalid_kv_delim(self):
        """Test by trying to set a value into given key position with invalid kv_delim mentioned."""
        set_cmd = "conf json:///tmp/file1.json set -d { cluster>id}093d"
        set_cmd_proc = SimpleProcess(set_cmd)
        result_data = set_cmd_proc.run()
        self.assertTrue( True if result_data[2]==22 else False)
    ...
    def test_conf_cli_multiple_kv_delim(self):
        """Test by trying to set a value into given key position with multiple kv_delim argument."""
        set_cmd = "conf json:///tmp/file1.json set -d : : cluster>id:093d"
        set_cmd_proc = SimpleProcess(set_cmd)
        result_data = set_cmd_proc.run()
    ...
    def test_conf_cli_multiple_value_split_kv_delim(self):
        """Test by setting a value into given key position with multiple value split kv_delim."""
    ...
    def test_conf_cli_with_kv_delim_in_value(self):
        """Test by setting a value into given key position with value contains kv_delim."""
    ...
    def test_conf_cli_properties_wrong_format_kv(self):
        """Test by reading invalid k#V format key value and validate the result error message."""
