...
def generate_support_bundle():
    ...
    options = {'bundle_id': bundle_id, 'comment': comment, 'node_name': nodename, 'components': components, 'comm': {'type': 'direct', 'target': 'csm.cli.support_bundle', 'method': 'init', 'class': 'ComponentsBundle', 'is_static': True, 'params': {}, 'json': {}}, 'output': {}, 'need_confirmation': False, 'sub_command_name': 'bundle_generate'}
...
def get_bundle_status(bundle_id: str):
    ...
    options = {'bundle_id':bundle_id, 'comm': {'type': 'direct', 'target': 'csm.cli.support_bundle', 'method': 'init', 'class': 'SupportBundle', 'is_static': True, 'params': {}, 'json': {}}, 'output': {}, 'need_confirmation': False, 'sub_command_name': 'get_bundle_status'}
...
bundle_id = generate_support_bundle()
