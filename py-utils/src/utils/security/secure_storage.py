...
class SecureStorage:
    ...
    async def _get_item(self, name: str) -> NamedEncryptedBytes:
        ...
        :return: NamedEncryptedBytes object if the item with provided name exists or None
        """
    ...
    async def store(self, name: str, data: bytes, force=False) -> None:
        ...
        Raises KeyError if an item with the provided name exists and "force" flag is not set.
        """
