...
class MappedConfStore:
    """ Config Store mapped to a fixed index """
    ...
    def copy(self, src_url: str):
        """Copy src_index config into confstore location."""
        try:
            Conf.load('src_index', src_url, skip_reload=True)
    ...
    def search(self, parent_key, search_key, value):
        """Search for given key under parent key in confstore."""
