...
pipeline { 
    agent {
        node {
            label 'docker-centos7.7.1908-prvsnr-github-node'
        }
    }
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'github-ssh', url: 'git@github.com:Seagate/ees-prvsnr.git']]])
            }
        }
