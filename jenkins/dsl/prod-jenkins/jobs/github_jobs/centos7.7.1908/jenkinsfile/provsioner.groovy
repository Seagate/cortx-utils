    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'github-shailesh-ssh', url: 'git@github.com:Seagate/ees-prvsnr.git']]])
            }
        }
