...
pipeline {
	...
	environment {    
        ...
        build_upload_dir_s3="$release_dir/components/${pipeline_group}/${os_version}/${env}/s3server"
        build_upload_dir_hare="$release_dir/components/${pipeline_group}/${os_version}/${env}/hare"
                ...
                catchError(buildResult: 'SUCCESS') {
                    ...
                    sh label: 'copy_to_new_nfs', script: '''
                        ...
                        pushd $nfs_upload_path
							...
							# Hare Build 
							build_upload_dir_hare_nfs=/mnt/data1/releases/eos/components/${pipeline_group}/${os_version}/${env}/hare
							build_upload_dir_s3_nfs=/mnt/data1/releases/eos/components/${pipeline_group}/${os_version}/${env}/s3server

							test -d $build_upload_dir_hare_nfs/last_successful && rm -f $build_upload_dir_hare_nfs/last_successful
							ln -s $build_upload_dir_hare_nfs/$HARE_BUILD_NUMBER $build_upload_dir_hare_nfs/last_successful

							# S3Server Build
							test -d $build_upload_dir_s3_nfs/last_successful && rm -f $build_upload_dir_s3_nfs/last_successful
							ln -s $build_upload_dir_s3_nfs/$S3_BUILD_NUMBER $build_upload_dir_s3_nfs/last_successful
                        popd
                    '''
                }
			}
